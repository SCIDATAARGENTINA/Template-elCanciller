...
//{
jQuery('#new').append('<img class=\"onlydesktop\" style=\"margin: 0 auto;\" src=\"https://elcanciller.com/wp-content/uploads/2020/02/apertura-desktop.jpg\"><img class=\"onlymobile\" src=\"https://elcanciller.com/wp-content/uploads/2020/02/apertura-mobile.jpg\" class=\"onlymobile\" style=\"margin: 0 auto;padding-top: 2%;\">');
//}
});
				</script>
				<?php echo get_field('vertical_home_1', 'option') ?>
				<?php get_template_part('template-parts/home/trending', 'front') ?>
				<div id="new" style="margin-bottom: 4%;"></div>
